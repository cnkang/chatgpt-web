...
export default {
  ...
  chat: {
    ...
    mobileMenuActions: 'Thao tác khác',
    emptyStateTitle: 'Bắt đầu với một yêu cầu rõ ràng',
    emptyStateDescription:
      'Chọn một gợi ý mở đầu bên dưới hoặc nhập nội dung của bạn để bắt đầu cuộc trò chuyện tập trung hơn.',
    starterSummarize: 'Tóm tắt yêu cầu này và rút ra các đầu việc',
    starterPlan: 'Biến tác vụ này thành kế hoạch phát triển có thể thực thi',
