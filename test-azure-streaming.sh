...
echo ""
echo "📚 Documentation:"
echo "  - packages/docs/development/troubleshooting.md - Azure streaming and Docker troubleshooting"
echo "  - packages/docs/deployment/environment.md - Azure/OpenAI environment setup"
echo "  - packages/docs/deployment/docker.md - Docker deployment guide"
echo ""
echo "✨ Happy testing!"
